...
#' @description This dataset is a subset of the final outcome of a quantitative mass
...
#'
#' The data frame assay(subR25prot) contains six columns that are the
#' quantitation of proteins for the six replicates.
#'
#' The data frame fData(subR25prot) contains the meta data about the proteins.
#'
#' The data frame pData(subR25prot) contains the experimental design and gives
...
#'
#' The data frame pData(subR25pept) contains the experimental design and gives
