...
#' 
#' In this example, `PipelineB_Process2_ui()` and `PipelineB_Process2_server()` define
#' the code for the process `Process2` which is part of the pipeline called `PipelineB`.
...
#' @export
#'
PipelineB_Process2_ui <- function(id){
  ns <- NS(id)
}
...
#' @export
#' 
PipelineB_Process2_server <- function(id,
