...
<!-- The `DAPAR` and `Prostar2` packages are a series of software dedicated to  -->
...
<!-- with; or through the `Prostar2` interface. -->
<!-- `Prostar2` (Proteomics statistical analysis with R) is a  -->
...
<!--  examples. -->
<!-- `Prostar2` functionalities make it possible to easily: -->
...
<!-- The \textbf{Dataset manager} allows it to open, import or export quantitative datasets. \Biocpkg{Prostar} relies on the MSnSet format which is part of the package \Biocpkg{MSnbase}: -->

<!-- It is either possible to load existing MSnSet files (see  -->
<!-- Section~\ref{sec:load}), or to import text (-tabulated) and Excel files (see Section~\ref{sec:import}). The \textbf{Demo data} menu allows it to load the datasets of the package \Biocpkg{DAPARdata} as examples to discover \Biocpkg{Prostar} functionalities (see Section~\ref{sec:demomode}). -->
